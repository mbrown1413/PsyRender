...
struct canvas_func_table {
    ...
    Color* (*get_next_row)(struct Canvas_struct* canvas);
...
#define Canvas_get_next_row(canvas) \
    (canvas)->func.get_next_row((Canvas*) canvas)
...
#define Canvas_free(canvas) free(canvas)
